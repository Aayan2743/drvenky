            ...
            <div class="flex items-center justify-between gap-5">
                ...
                <nav class="header-nav hidden lg:block">
                    <ul class="header-nav-list">
                        ...
                        <!-- static -->
                        <button type="button" class="header-nav-menu " onclick="window.open('https://drvenkysanimalhospital.com/home#our-services', '_blank')">
                            Clinic Services
                        </button>
...
export default {
    ...
    categories3: categoriesData.categories3,
      activeTab2: categoriesData.activeTab2,
      categories2: categoriesData.categories2,
