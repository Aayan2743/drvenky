            ...
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <!-- new -->
                    <div class="form-col-12 sm:form-col-6">
                        <label for="HsnCode" class="db-field-title required">HSN Code</label>
                        <input v-model="props.form.HsnCode" v-bind:class="props.form.HsnCode ? 'invalid' : ''" type="text" id="HsnCode"
                            class="db-field-control">
                        <small class="db-field-alert" v-if="errors.HsnCode">{{ errors.HsnCode[0] }}</small>
                    </div>
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label for="barcode_id" class="db-field-title required">Bar Code No</label>
                        <input v-model="props.form.barcode_id" v-bind:class="props.form.barcode_id ? 'invalid' : ''" type="text" id="barcode_id"
                            class="db-field-control">
                        <small class="db-field-alert" v-if="errors.barcode_id">{{ errors.barcode_id[0] }}</small>
                    </div>
