        ...
        <div class="modal-dialog max-w-[302px] rounded-none" id="print">
            <div class="modal-body">
                ...
                <table class="w-full my-1.5">
                    ...
                    <tr>
                        <td class="text-xs text-left py-0.5 text-heading"> Customer Name - {{ order.user.name }}</td>
                        <td class="text-xs text-right py-0.5 text-heading">Customer Phone - {{ order.user.phone }} </td>
                    </tr>
                </table>
                    ...
                    <table class="w-full">
                        ...
                        <tr>
                            ...
                            <td class="text-xs text-right py-0.5 font-bold text-heading">
                                {{ order.custom_total_currency_price }}
                            </td>
                        </tr>
                    </table>
                </div>
