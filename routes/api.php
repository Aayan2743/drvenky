...
// Route::post('/send-otp', [\App\Http\Controllers\Auth\LoginController::class, 'sendOTP']);
...
Route::prefix('admin')->name('admin.')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('setting')->name('setting.')->group(function () {
        ...
        Route::prefix('product-category')->name('product-category.')->group(function () {
            ...
            Route::get('/tree1', [ProductCategoryController::class, 'tree1']);
    ...
    Route::prefix('product')->name('product.')->group(function () {
        ...
        Route::get('/search_byid/{id}', [ProductController::class, 'search_byid']);
        Route::get('/show/{product}', [ProductController::class, 'show']);
        Route::get('/pos-product/{product}', [ProductController::class, 'posProduct']);
        Route::get('/pos-product1/{product}', [ProductController::class, 'posProduct1']);
    ...
    Route::prefix('users')->name('users.')->group(function () {
        ...
        Route::get('/list_customers', [SimpleUserController::class, 'list_customers']);
    });
    ...
    Route::prefix(prefix: 'return-order')->name('return-order.')->group(function () {
    ...
    Route::prefix('pos-order')->name('posOrder.')->group(function () {
        ...
        Route::get('/cc', [PosOrderController::class, 'index1']);
...
Route::get('search_byid/{id}', [ProductController::class, 'search_byid']);
Route::post('add_customer', [ProductController::class, 'add_customer']);
// Route::post('add_customer', [ProductController::class, 'add_customer']);
Route::post('query_form', [ProductController::class, 'query_form']);
