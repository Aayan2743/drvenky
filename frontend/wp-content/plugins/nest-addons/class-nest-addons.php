  ...
  public function update_theme_plugin() {
    ...
    */
    public function add_nest_extra(){ 
        ...
        require_once NEST_ADDONS_DIR . '/woocommerce/cart-action.php'; 
