...
function nest_sales_badges_two(){
    ...
    $enable_badge =  isset( $nest_theme_mod['badge_enable'] ) ? $nest_theme_mod['badge_enable'] : '';
   if($enable_badge == true || get_post_meta(get_the_ID(), 'product_percent_show', true) == true):  
    if($product->is_on_sale() && $product->is_type( 'variable' )):   ?> 
        ...
        <?php endif; ?> 
 <?php endif; ?> 
   <?php if($enable_badge == true || get_post_meta(get_the_ID(), 'product_percent_show', true) == true): ?>
<?php if(!empty($onsale)): ?>
        ...
        if ($product) {
            ...
            <div class="d-flex align-items-center">
                <span class="font-xs text-heading"><?php echo esc_html__('Sold' , 'steelthemes-nest'); ?> : <?php echo esc_attr($sold_quantity); ?>
                    <?php echo esc_html('/'); ?> <?php echo esc_attr($total_quantity); ?> 
                </span>  
